...
egrep 'Country|SMO3' Select_COVID_data_PEAKS.ALL.csv | cut -d"," -f1,8,13,20,27-999 | sed 's/,,/,0,/g' | sed 's/,,/,0,/g' | sed 's/,/ /g' | sed 's/__Federal_Correctional_Institution_FCI//' | sed 's/__Michigan_Department_of_Corrections_MDOC//' > step1.tmp
...
cp -a step2_00.tmp Select_COVID_data_PEAKS.SMO3.ALL._00.ftxt
...
cp -a step2_10.tmp Select_COVID_data_PEAKS.SMO3.ALL._10.ftxt
...
cp -a step2_20.tmp Select_COVID_data_PEAKS.SMO3.ALL._20.ftxt
...
cp -a step2_30.tmp Select_COVID_data_PEAKS.SMO3.ALL._30.ftxt
...
cp -a step2_40.tmp Select_COVID_data_PEAKS.SMO3.ALL._40.ftxt
...
cp -a step2_50.tmp Select_COVID_data_PEAKS.SMO3.ALL._50.ftxt
...
cp -a step2_90.tmp Select_COVID_data_PEAKS.SMO3.ALL._90.ftxt
