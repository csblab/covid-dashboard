...
# Process Step 1
# --------------
Process_JHU_COVID_v3_Step1.TEST.pl > Process_JHU_COVID_v3_Step1=.log

cat Process_JHU_COVID_v3_Step1=.log | egrep -v 'FIX|SOR0|SORT|_error|ML|PLACE|MINUS|SPE:' | egrep '^DATES|^Country|Confirmed|Deaths' > Data_COVID-19_SMOO_UNSM_Space_Sep_data.txt.2.CURRENT
